...
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, automata, shapes, decorations}
\usepackage{pgfplots}
...
% \usepackage{emoji} % Requires LuaLatex compiler; on Ubuntu: requires package fonts-noto-color-emoji
...
\newcommand{\examnum}{Makeup Exam}
\newcommand{\examdate}{1/19/2023}
...
\newcommand{\yemoji}[1]{\text{\emoji{#1}}}
\newcommand{\xtext}[1]{\underline{\texttt{#1}}}
