...
\textbf{\class} & \textbf{Name:} & {Zian Pan}\\
\textbf{\term} &  \textbf{Andrew ID:} & {zianp} \\
\textbf{\examnum} & \textbf{Room:} & {DH A302}\\
\textbf{\examdate} & \textbf{Seat:} & {F07} \\
\textbf{Time Limit: \timelimit} & \textbf{Exam Number:} & {332}
\end{tabular*}\\
