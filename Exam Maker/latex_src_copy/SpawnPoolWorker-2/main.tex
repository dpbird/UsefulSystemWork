...
\textbf{\class} & \textbf{Name:} & {Zoë Lalena}\\
\textbf{\term} &  \textbf{Andrew ID:} & {zlalena} \\
\textbf{\examnum} & \textbf{Room:} & {DH A302}\\
\textbf{\examdate} & \textbf{Seat:} & {F19} \\
\textbf{Time Limit: \timelimit} & \textbf{Exam Number:} & {338}
\end{tabular*}\\
...
\input{qs-logreg.tex}
\clearpage
\input{qs-neuralnets.tex}
\clearpage
\input{qs-theory.tex}
\clearpage
\input{qs-societal.tex}
\clearpage
%\input{qs-misc.tex}
% \clearpage
\end{questions}
