...
\textbf{\class} & \textbf{Name:} & {Claire Li}\\
\textbf{\term} &  \textbf{Andrew ID:} & {zixinli} \\
\textbf{\examnum} & \textbf{Room:} & {DH A302}\\
\textbf{\examdate} & \textbf{Seat:} & {F09} \\
\textbf{Time Limit: \timelimit} & \textbf{Exam Number:} & {333}
\end{tabular*}\\
