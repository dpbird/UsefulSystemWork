...
\textbf{\class} & \textbf{Name:} & {Ziyu Cai}\\
\textbf{\term} &  \textbf{Andrew ID:} & {ziyuc} \\
\textbf{\examnum} & \textbf{Room:} & {DH A302}\\
\textbf{\examdate} & \textbf{Seat:} & {F15} \\
\textbf{Time Limit: \timelimit} & \textbf{Exam Number:} & {336}
\end{tabular*}\\
