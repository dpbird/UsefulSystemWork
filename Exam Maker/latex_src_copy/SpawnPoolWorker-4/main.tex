...
\textbf{\class} & \textbf{Name:} & {Ziang Sun}\\
\textbf{\term} &  \textbf{Andrew ID:} & {ziangs} \\
\textbf{\examnum} & \textbf{Room:} & {DH A302}\\
\textbf{\examdate} & \textbf{Seat:} & {F05} \\
\textbf{Time Limit: \timelimit} & \textbf{Exam Number:} & {331}
\end{tabular*}\\
