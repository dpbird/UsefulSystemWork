...
\textbf{\class} & \textbf{Name:} & {Ziyue Li}\\
\textbf{\term} &  \textbf{Andrew ID:} & {ziyuel} \\
\textbf{\examnum} & \textbf{Room:} & {DH A302}\\
\textbf{\examdate} & \textbf{Seat:} & {F17} \\
\textbf{Time Limit: \timelimit} & \textbf{Exam Number:} & {337}
\end{tabular*}\\
